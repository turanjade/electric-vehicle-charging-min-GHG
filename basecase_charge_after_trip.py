...
print('base case: only level 1 charging (w&w.o penalty): ', round( min_ghg_MEF(base_lv1)[0],2), round(ghg_cal(base_lv1),2))
...
print('base case: lv1 and lv2 charging (w&w.o penalty): ', round(  min_ghg_MEF(base_lv2)[0],2), round(ghg_cal(base_lv2),2))
...
print('base case: lv1, lv2, and lv3 charging (w&w.o penalty): ', round(min_ghg_MEF(base_lv3)[0],2), round(ghg_cal(base_lv3),2))
